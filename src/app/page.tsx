      ...
      <section id="aboutme" className={` lg:p-20  flex flex-col justify-center pb-21 transition-colors duration-300 ${theme === 'dark' ? 'dark' : 'light'} gap-10 items-center lg:h-screen `}>
        ...
        <div className="flex lg:flex-row lg:p-0 pt-30 items-center flex-col gap-10">
          ...
          <div className={`w-100 flex flex-col gap-3 `}>
            ...
            <p className={`text-center lg:text-start transition-colors duration-300 ${theme === 'light' ? 'color-font-preto-30 ' : 'color-font-branco-30'}`}>      Sou estudante do 5° semestre Engenharia de Software, apaixonada por tecnologia, lógica e inovação. Gosto de resolver problemas de forma criativa e analítica, sempre buscando aprender e evoluir.   Acredito no poder transformador da tecnologia e no impacto positivo que ela pode gerar.</p>
          </div>
          ...
          <div className="flex flex-col gap-0 rounded-lg lg:overflow-hidden ">
            <button 
              className={`${theme === 'dark' 
                ...
                px-8 py-4 text-lg font-medium transition-all duration-200 relative cursor-pointer`} 
